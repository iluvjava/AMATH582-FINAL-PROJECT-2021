...
model = load_model('./CNN_Models/custom-model-letters-best.h5')
...
_, test_y_label = extract_test_samples("letters")


# In[5]:


df=pd.read_csv('./CNN_Models/history-custom-model-letters-best.csv')
...
plt.tight_layout()
plt.savefig('CNN-letters-best.pdf')
plt.show()
